...
document.getElementsByTagName('head')[0].innerHTML += "<img src=\"./imgs/button.png\" id=\"bttnImage\"></img>\n";
document.getElementsByTagName('head')[0].innerHTML += "<img src=\"./imgs/button_over.png\" id=\"bttnImageOver\"></img>\n";
document.getElementsByTagName('head')[0].innerHTML += "<img src=\"./imgs/button_pushed.png\" id=\"bttnImagePushed\"></img>\n";
...
function Button(canvas, x, y, w, height){
	...
	this.width = (w > 10*this.text.length)? w : 10*this.text.length;
	this.height = (height > 40)? height : 40;
